...
/**
 * This is the model class for table "{{request_company_autopark}}".
 *
 * The followings are the available columns in table '{{request_company_autopark}}':
 * @property string $id
 ...
 */
class RequestCompanyAutopark extends CActiveRecord
{
	/**
	...
	{
		return '{{request_company_autopark}}';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('model, price_outside, price_inside', 'length', 'max'=>64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, request_ptr_id, model, type, amount, price_outside, price_inside', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return RequestCompanyAutopark the static model class
	 */
