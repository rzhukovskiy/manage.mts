...
/**
 * This is the model class for table "{{employee_group_archive_request_type}}".
 *
 * The followings are the available columns in table '{{employee_group_archive_request_type}}':
 * @property string $id
 ...
 */
class EmployeeGroupArchiveRequestType extends CActiveRecord
{
	/**
	...
	{
		return '{{employee_group_archive_request_type}}';
	}
	 ...
	 * @return EmployeeGroupArchiveRequestType the static model class
	 */
