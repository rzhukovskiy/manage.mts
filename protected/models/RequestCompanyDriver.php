...
/**
 * This is the model class for table "{{request_company_driver}}".
 *
 * The followings are the available columns in table '{{request_company_driver}}':
 * @property string $id
 ...
 */
class RequestCompanyDriver extends CActiveRecord
{
	/**
	 ...
	 * @return RequestCompanyDriver the static model class
	 */
