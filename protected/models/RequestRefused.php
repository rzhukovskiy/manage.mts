...
/**
 * This is the model class for table "{{request_refused}}".
 *
 * The followings are the available columns in table '{{request_refused}}':
 * @property string $id
 * @property string $request_id
 * @property string $created
 */
class RequestRefused extends CActiveRecord
{
	/**
